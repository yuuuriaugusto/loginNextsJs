        ...
        <Layout>
            ...
            <section className='w-5/6 mx-auto flex flex-col gap'>
                <div className='title'>
                    ...
                    <p className='w-3/4 mx-auto text-gray-400'>texto texto texto texto texto</p>
                </div>
                ...
                <p className='text-center text-gray-400'>
                    Have an accont? <Link legacyBehavior href={'./login'}><a className='text-blue-700'>Sing In</a></Link>
                </p>
            </section>
        </Layout>
    )
